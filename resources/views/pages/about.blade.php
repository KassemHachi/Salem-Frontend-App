...
<section class="relative min-h-[589px] bg-cover" style="background: url('')">
    ...
    <div class="absolute top-0 z-10 flex items-center h-full px-20 start-0">
    ...
    <svg class=" absolute right-0 z-[1] -top-[10%] h-96" viewBox="0 0 174 475" fill="none"
    ...
    <x-icons.palatte-element class="absolute right-0 top-[15%] z-[1] h-96 w-fit" />


</section>

<article class="min-h-screen px-20 py-[3.75rem]">

    <h3 class="text-[25px] font-semibold text-salem-dark-blue-500" data-aos="fade-up" data-aos-delay="0"
        data-aos-duration="500">

        من هو سالم بن علي بن بغيّه العجمي:

    </h3>
    <p class="text-base text-[#333]" data-aos="fade-up" data-aos-delay="0" data-aos-duration="500">
